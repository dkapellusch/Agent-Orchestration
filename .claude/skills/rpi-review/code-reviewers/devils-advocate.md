---
description: Devil's advocate adversarial code review - forces deep logical analysis via structured debate rounds between Author and Reviewer personas
...
```
!`BASE_BRANCH=$(git remote show origin 2>/dev/null | sed -n '/HEAD branch/s/.*: //p'); BASE_BRANCH=${BASE_BRANCH:-main}; git diff "$BASE_BRANCH"...HEAD`
```
